...
/**
 * Description of categorytall
 *
 * @author user
 */
class categorytall extends CI_Controller {
...
//        load and set title and meta data from database
        $data['title'] = $this->modelsetting->getdetailsetting(1)->title . '| All Category ';
...
//        set path directory themes
       $data['path'] = base_url() . '' . $themes . '' . $load;
        ...
        $this->load->view($load . 'category', $data);
