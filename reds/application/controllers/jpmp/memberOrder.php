...
/**
 * Description of memberOrder
 *
 * @author user
 */
class memberOrder extends CI_Controller{
    //put your code here
    ...
    function tablecontent() {
        ...
        foreach ($querytable->result() as $rowtable) {
            $content.='<tr>
                                        ...
                                        <a href="' . base_url() . 'jpmp/detailMemberOrder?id=' . $rowtable->id_member . '&act=view"><i class="fa fa-user" title="view detail" style="cursor:pointer;"  ></i></a> 
