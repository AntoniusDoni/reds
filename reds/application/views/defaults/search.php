...
<script>
                                function getLoadCategoryProduct(pages) {
                                    $(document).ready(function() {
                                        $.ajax({
                                            url: "<?php echo base_url(); ?>search/getLoadCategoryProduct",
                                            data: "pages=" + pages + "&sortby=" + $("#sort-by").val() + "&showno=" + $("#show-no").val() + "&rangeprice=" + $("#range-price").val() + "&serachproduct=<?= $serachproduct?>",
                                            type: 'POST',
                                            dataType: 'json',
                                            beforeSend: function() {
