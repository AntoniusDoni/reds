<?php if ($this->modelcategory->getdetailcategory($idcategory)->category_images != '') { ?>
    <section class="page-head hidden-xs">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <figure>
                        <img src="<?= $this->modelcategory->getdetailcategory($idcategory)->category_images; ?>" alt="" />
                    </figure>
                </div>
            </div>
        </div>
                                ...
                                function getLoadCategoryProduct(pages) {
                                    $(document).ready(function() {
                                        $.ajax({
                                            ...
                                            data: "pages=" + pages + "&sortby=" + $("#sort-by").val() + "&showno=" + $("#show-no").val() + "&rangeprice=" + $("#range-price").val() + "&idcategory=<?= $idcategory; ?>",
                                            type: 'POST',
                                            dataType: 'json',
                                            beforeSend: function() {
