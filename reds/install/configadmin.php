...
if ($_POST) {
    ...
    if ($core->validate_post($_POST) == true) {
        ...
        if ($database->write_config($_POST) == false) {
            $message = $core->show_message('error', "The database could not be created, please verify your settings.");
        }
//                else if($database->create_tableadmin($_POST) == false){
//                    $message = $core->show_message('error',"The configure admin could not be created, please verify your settings.");
//                }
        ...
        if (!isset($message)) {
            ...
            header('Location: ' . $redir . 'jpmp/beadmin');
        }
    } else {
        ...
        echo '<p class="error">' . $message . '</p>';
            ...
            <form id="install_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                <fieldset>
                    ...
                    <label for="username">Username Database</label><input type="text" id="username" class="input_text" name="username" />
                    <label for="password">Password Database</label><input type="password" id="password" class="input_text" name="password" />
