...
insert  into `member`(`id_member`,`name`,`emails`,`phone`,`address`,`password`,`dates_entry`,`member_themes`) values (1,'antonius Doni','donioantonius@gmail.com','08789364667','Jalan wates|Bantul|DI Yogyakarta|Indonesia','admin',NULL,'afro'),(2,'Antonius Doni O','info@afroskincosmetics.com','08789364667','Jalan Adi Sucipto|Denpasar|Bali|Indonesia','admin',NULL,'afro');
...
insert  into `post`(`id_post`,`id_category`,`title`,`images`,`metaTag`,`metadescription`,`post_randcode`,`url`,`dates_post`,`is_publish`,`creat_id`) values (1,0,'About Us','http://localhost/reds/images/data/o-FASHION-facebook.jpg','about us','about us','ea8e41da0f2940c1788387c4e99d58f3','About-Us','2016-07-22 13:51:04',1,'donioantonius@gmail.com'),(2,0,'Lorem Ip Sum','http://localhost/reds/images/data/slider6.jpg','Be Admin,Lorem ipsum','Be Admin,Lorem ipsum','536de7e04989f64a9a9ef310843646fb','Lorem-Ip-Sum','2016-07-22 14:08:23',1,'donioantonius@gmail.com'),(3,0,'Article','http://localhost/reds/images/data/o-FASHION-facebook.jpg','artikel','artikel','cdabc434f2c8bbc1d92f128d13f44ef7','Article','2016-07-22 14:11:22',1,'donioantonius@gmail.com');
...
insert  into `post_description`(`id_post_description`,`description`,`lang`,`id_post`) values (1,'','ID',1),(2,'','EN',1),(3,'<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.<br />\r\n&nbsp;','ID',2),(4,'','EN',2),(5,'<strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.<br />\r\n&nbsp;','ID',3),(6,'','EN',3);
...
insert  into `setting`(`idgm`,`title`,`emails`,`gplus`,`fb`,`twiter`,`theme`,`password`,`address`,`tlp`,`isecommer`,`versioning`,`metaKeyword`,`metaDescription`) values (1,'My Web','donioantonius@gmail.com',NULL,NULL,NULL,'defaults','admin',NULL,NULL,1,1,'Open source Code with codeigniter.,codeigniter,code,open source','Open source Code with codeigniter.,codeigniter,code,open source');
